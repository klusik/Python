# #In order to prove it's success and gain funding, the wilderness zoo needs to prove to environmentalists that it
# # has x number of mating pairs of bears.
#
...
# false if not: # (6, 'EvHB8KN8ik8BiyxfeyKBmiCMj') ---> ['B88B', # # false];
...
def bears(x,s):
    ...
    def find_all(string, substring):
        ...
        while c < len(string):
            ...
            c = c + 1
        return indexes
    def printBears(indexes):
        listOfPairs = []

        for i in indexes: # i contains found  index of substring
            #use i to identify character in s, save s +1 character into listOfPair
            endIndex = i + 2
            Pair = s[i:endIndex]
