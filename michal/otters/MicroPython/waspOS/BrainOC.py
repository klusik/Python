...
# Copyright (C) 2021 Michal Sykora
"""Brain Overclock Application
~~~~~~~~~~~~~~~~~~~~

An application to set a vibration alarm repeatedly and indefinetly (until user abort). 
An app is small modification of original Alarm Application by Daniel Thompson and Joris Warmbier
All settings can be accessed from the Watch UI.

    .. figure:: res/BrainOCApp.png
        :width: 179

        Sa regularly triggered eenshot of the Alarm Application
...
### to by me zajimalo, jak tohle rozklicovat...
icon = (
    b'\x02'
    b'`@'
...
class BrainOCApp():
    """Allows the user to set a regularly triggered vibration alarm.
    """
    NAME = 'BrainOC'
    ICON = icon
    ...
    def __init__(self):
        ...
        self.active = widgets.Checkbox(104, 200) # cisla jsou souradnice objektu na displayi
        self.hours = widgets.Spinner(50, 60, 0, 23, 2) # argumenty jsou x, y, mn, mx a field
    ...
    def foreground(self):
        ...
        self._draw()
        wasp.system.request_event(wasp.EventMask.TOUCH) # zaregistruje matlani po displayi jako systemove volani
        wasp.system.request_tick(1000) # register periodic tick event, currently unavailable values lower than 1000ms
